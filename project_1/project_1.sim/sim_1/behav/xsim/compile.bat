...
REM
REM Generated by Vivado on Tue Apr 14 16:27:40 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj bnn_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj bnn_tb_vlog.prj -log xvlog.log
